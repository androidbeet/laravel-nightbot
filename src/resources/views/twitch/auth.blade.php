            ...
            <div class="row h-100">
                <div class="col-md-10 col-xl-10 mx-auto align-self-center mt-6">
                    ...
                    <p class="lead-3 col-xl-9 col-md-9 mx-auto mt-6 mb-7">
                        @lang('nightbot::auth.title')
                    </p>
                    <a href="" style="background-color: #613f9f; color: white;" class="btn btn-xl fs-20 fw-500 w-350 shadow-3 hidden-sm-down border-glass-2" >
                ...
                {{--<a class="scroll-down-1 scroll-down-white" href="#contacts"><span></span></a>--}}
                {{--</div>--}}

                <div class="col-lg-8 mx-auto align-self-center pt-2">

                    <a class="font-size-18" href="mail:yourmail@mailhost.com">
                        your@email.com
                    </a>
